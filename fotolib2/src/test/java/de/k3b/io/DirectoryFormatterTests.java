...
public class DirectoryFormatterTests {
    ...
    public void shoudGetLatLon10() {
        GeoRectangle result = DirectoryFormatter.getLatLon(" 130,12");
    ...
    public void shoudGetLatLon0() {
        GeoRectangle result = DirectoryFormatter.getLatLon("130.0,12.0");
        Assert.assertEquals("130.0,12.0..130.1,12.1", result.toString());
    }

    @Test
    public void shoudGetLatLon00() {
        GeoRectangle result = DirectoryFormatter.getLatLon("130.00,12.00");
