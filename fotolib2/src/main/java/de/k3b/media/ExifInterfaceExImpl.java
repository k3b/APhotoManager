...
public class ExifInterfaceExImpl extends ExifInterface implements ExifInterfaceEx {
     ...
     */
    public ExifInterfaceExImpl(String absoluteJpgPath, InputStream in, IPhotoProperties xmpExtern, String dbg_context) throws IOException {
    ...
    protected ExifInterfaceExImpl() {super();xmpExtern=null; mDbg_context = "";}
        ...
        if (factory == null) {
            factory = new ExifInterfaceFactory() {
                ...
                public ExifInterfaceEx createExifInterface(String absoluteJpgPath, InputStream in, IPhotoProperties xmpExtern, String dbg_context) throws IOException {
                    return new ExifInterfaceExImpl(absoluteJpgPath, in, xmpExtern, dbg_context);
                }
            };
        }
        return factory;
    ...
    @Override
    public boolean isValidJpgExifFormat() {return super.isValidJpgExifFormat();}
