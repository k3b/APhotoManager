 ...
 * tree.
 * <p>
 * As you navigate the tree of DocumentFileEx instances, you can always use
...
public abstract class DocumentFileOrininal {
    ...
    /**
     * Create a {@link DocumentFileEx} representing the single document at the
     ...
     */
    @Nullable
    public static DocumentFileEx fromSingleUri(@NonNull Context context, @NonNull Uri singleUri) {
    ...
    /**
     * Create a {@link DocumentFileEx} representing the document tree rooted at
     ...
     */
    @Nullable
    public static DocumentFileEx fromTreeUri(@NonNull Context context, @NonNull Uri treeUri) {
     ...
     */
    @Nullable
    public abstract DocumentFileEx createFile(@NonNull String mimeType, @NonNull String displayName);
     ...
     */
    @Nullable
    public abstract DocumentFileEx createDirectory(@NonNull String displayName);
     ...
     */
    @NonNull
    public abstract DocumentFileEx[] listFiles();
     ...
     */
    @Nullable
    public DocumentFileEx findFile(@NonNull String displayName) {
        for (DocumentFileEx doc : listFiles()) {
